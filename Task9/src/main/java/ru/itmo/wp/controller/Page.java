...
public class Page {
    ...
    public String ifCorrectId(String strId, String redirect, IdRequestHandler handler) {
        try {
            return handler.execute(Long.parseLong(strId));
    ...
    @FunctionalInterface
    public interface IdRequestHandler {
        String execute(long id) throws RuntimeException;
    }
}
